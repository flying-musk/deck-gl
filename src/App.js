  ...
  return (
    <>
      <div className="absolute z-[100] top-[0] left-[0] right-[0] bg-[white] border-b p-[16px] pb-[12px] flex flex-col gap-[12px]">
        ...
        <input className="outline-none grow self-stretch border rounded p-[6px] text-[14px]" type="text" onChange={handleInputChange} placeholder="Search for keywords like 'Park', etc." />
      </div>
